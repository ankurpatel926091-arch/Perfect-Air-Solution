          ...
          {sectors.map((sector, index) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-white rounded-xl overflow-hidden border border-slate-200/90 hover:border-[#0284C7] shadow-none hover:shadow-none transition-all duration-300 flex flex-col cursor-pointer font-sans"
              >
                {/* Image Container */}
                <div className="relative h-52 overflow-hidden bg-slate-100">
                  ...
                  {/* Glowing Icon Badge */}
                  <div className="absolute top-4 left-4 z-10 w-11 h-11 rounded-lg bg-gradient-to-tr from-[#051B30] to-[#0284C7] flex items-center justify-center text-white border border-white/20">
