...
// import projectHeaderBg from "@/assets/HeaderBackgroundImg/ProjectBackground.png";
...
//           <img
//             src={projectHeaderBg}
//             alt="Projects Perfect Air Solution"
//             className="w-full h-full object-cover object-center"
//           />
//           {/* Balanced soft gradient overlay so architectural skyline is vividly visible */}
...
//                   className={`px-4 py-2 rounded-md text-xs sm:text-sm font-bold transition-all duration-200 border ${
//                     isActive
...
//                 className="bg-white rounded-md border border-slate-200/90 hover:border-[#0284C7] shadow-none hover:shadow-none transition-all duration-300 overflow-hidden flex flex-col justify-between group"
//               >
//                 {/* Header Image */}
//                 <div>
...
//                     {/* Key Results */}
//                     <div className="bg-slate-50 p-4 rounded-md border border-slate-100 mb-2">
...
//                     className="w-full sm:w-auto bg-gradient-to-r from-[#0284C7] to-[#0369A1] hover:from-[#0369A1] hover:to-[#075985] text-white font-bold text-xs sm:text-sm py-3 px-5 rounded-md flex items-center justify-center gap-2 shadow-md hover:shadow-sky-500/25 transition-all"
//                   >
//                     <Download size={16} />
...
//                   <Link
//                     to="/contact"
//                     className="w-full sm:w-auto border border-slate-200 hover:border-sky-400 text-slate-700 hover:text-[#0284C7] bg-white font-bold text-xs sm:text-sm py-3 px-5 rounded-md flex items-center justify-center gap-1.5 transition-all text-decoration-none"
//                   >
