          ...
          <div className="lg:col-span-1 flex flex-col justify-between space-y-4">
            {features.map((f, i) => {
              ...
              return (
                ...
                >
                  {/* Icon Box */}
                  <div className={`w-11 h-11 rounded-lg bg-gradient-to-br ${f.color} text-white flex items-center justify-center shrink-0`}>
        ...
        >
          {trustPoints.map((tp) => {
            ...
            return (
              ...
              >
                <div className="w-9 h-9 rounded-lg bg-sky-100/70 text-[#0695CD] flex items-center justify-center shrink-0">
